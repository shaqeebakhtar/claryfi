...
const FeedbackDisplaySheet = ({ feedbackId }: { feedbackId: string }) => {
  ...
  return (
    ...
    >
      <SheetContent className="sm:max-w-[450px] h-auto m-3 rounded-md p-0">
        <SheetHeader className="px-6 pt-6">
          ...
          <SheetTitle className="text-xl text-left">{feedbackId}</SheetTitle>
        ...
        <div className="px-6 py-5 space-y-5">
          <div className="relative">
            ...
            <Button
              size="sm"
              className="absolute right-3 bottom-3 px-5"
              disabled
            >
              Post
            </Button>
